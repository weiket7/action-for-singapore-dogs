    ...
    <div class="row">
      <div class="col-sm-12">
        <div itemscope="" itemtype="http://schema.org/Product" class="product type-product row columns_padding_25">
          ...
          <div class="col-sm-6">
            <div class="images">
              <img :src="base_url + '/assets/images/dogs/' + adopt.image" class="attachment-shop_single wp-post-image" alt="" title="">
            </div>
          </div>
          ...
          <div class="summary entry-summary col-sm-6">
            ...
            <p>
              ...
              <i v-if="adopt.hdb" class="fas fa-home"></i>
            ...
            <ul class="nav nav-tabs" role="tablist">
              ...
              <li><a href="#tab3" role="tab" data-toggle="tab">Foster</a></li>
            </ul>
...
@section('script')
  <script>
    var vm = new Vue({
      ...
      created: function() {
        axios.get(this.base_url+'/api/adopt-view/'+this.slug)
          .then(response => {
