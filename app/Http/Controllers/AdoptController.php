...
class AdoptController extends Controller
{
    ...
    {
        $data['adopts'] = Adopt::select('adopt_id', 'stat', 'name', 'gender', 'birthday')->orderBy('adopt_id', 'desc')->get();
    ...
    {
        $query = Adopt::whereIn('stat', [AdoptStat::Available, AdoptStat::LongTermFostering]);
        if ($request->name) {
        ...
        $data['adopt_count'] = Adopt::whereIn('stat', [AdoptStat::Available, AdoptStat::LongTermFostering])->count();
        return $data;
    }
    ...
    {
        $term = $request->term;
        return Adopt::where('name', 'like', '%'.$term.'%')->whereIn('stat', [AdoptStat::Available, AdoptStat::LongTermFostering])
    ...
    public function page(Request $request, $current_page)
    {
        ...
        $rand = $request->session()->get('rand');
        $data['adopts'] = Adopt::whereIn('stat', [AdoptStat::Available, AdoptStat::LongTermFostering])
