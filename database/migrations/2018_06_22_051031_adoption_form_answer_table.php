...
class AdoptionFormAnswerTable extends Migration
{
  public function up()
  {
    ...
    $answers = [
      ...
      ['adoption_form_id'=>3, 'question'=>'Occupation', 'answer'=>1],
      ['adoption_form_id'=>3, 'question'=>'Working Hours', 'answer'=>2],
      ['adoption_form_id'=>3, 'question'=>'Experience with dogs', 'answer'=>3],
      ['adoption_form_id'=>3, 'question'=>'Have you had dog(s) before?', 'answer'=>4],
      ['adoption_form_id'=>3, 'question'=>'Do you currently have dog(s)?', 'answer'=>5],
      ['adoption_form_id'=>3, 'question'=>'Why do you want to adopt a dog?', 'answer'=>6],
      ['adoption_form_id'=>3, 'question'=>'Family and home', 'answer'=>7],
      ['adoption_form_id'=>3, 'question'=>'What type of housing do you live in?', 'answer'=>8],
      ['adoption_form_id'=>3, 'question'=>'Do you have a domestic helper?', 'answer'=>9],
      ['adoption_form_id'=>3, 'question'=>'How many family member(s) stay with you?', 'answer'=>10],
      ['adoption_form_id'=>3, 'question'=>'What age(s) are your family member(s)?', 'answer'=>11],
    ];
